import React, { forwardRef, ForwardedRef, useCallback, MouseEvent, useMemo } from 'react'
...
export const DropdownOption = forwardRef(({
  ...
  ...rest
}: DropdownOptionProps, ref: ForwardedRef<HTMLLIElement>) => {
  ...
  const onClick = useCallback((e: MouseEvent<HTMLLIElement>) => {
    ...
    newChecked
      ? dropdown.onAdd(value)
      : dropdown.onRemove(value)
