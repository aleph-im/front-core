...
export const Object11 = ({ color = '#ffffff' }: StyledObjectImgSvgProps) => {
  return (
    ...
    >
      <path
        d="M50.0001 28.13C56.5901 28.13 62.1701 30.67 64.1201 34.19C64.6001 33.32 64.8601 32.4 64.8601 31.44C64.8601 26.57 58.2001 22.63 49.9901 22.63C41.7801 22.63 35.1201 26.57 35.1201 31.44C35.1201 32.4 35.3801 33.33 35.8601 34.19C37.8101 30.67 43.3901 28.13 49.9801 28.13H50.0001Z"
        fill={color}
        stroke={color}
        strokeLinecap="round"
      ...
      />
      <path
        d="M49.9999 40.24C56.5899 40.24 62.1699 37.7 64.1199 34.18C62.1699 30.66 56.5899 28.12 49.9999 28.12C43.4099 28.12 37.8299 30.66 35.8799 34.18C37.8299 37.7 43.4099 40.24 49.9999 40.24Z"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      ...
      />
      <path
        d="M50.0005 51.5601C47.7905 51.5601 45.6305 51.4301 43.5405 51.1801L48.7405 87.5301C49.1505 87.5701 49.5705 87.59 50.0005 87.59C50.6505 87.59 51.2805 87.5401 51.8905 87.4601V51.5201C51.2605 51.5401 50.6405 51.5601 50.0005 51.5601Z"
        fill={color}
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M55.5103 51.2901L54.7603 86.7101C55.0303 86.6001 55.2903 86.4701 55.5403 86.3401L60.9003 50.4601C59.1603 50.8201 57.3603 51.1001 55.5103 51.2801V51.2901Z"
        fill={color}
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
