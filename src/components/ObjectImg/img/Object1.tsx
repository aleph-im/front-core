...
export const Object1 = ({ color = '#ffffff' }: StyledObjectImgSvgProps) => {
  return (
    <svg width="auto" height="auto" viewBox="0 0 88 98" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M44.21 51.6841L87.42 26.5832L44.21 0.888535L1 26.5832L44.21 51.6841Z" stroke={color} stroke-linecap="round"
      ...
      <path d="M44.21 96.9415V51.6841L87.42 26.5832V72.1272L44.21 96.9415Z" fill={color} stroke={color}
        stroke-linecap="round" stroke-linejoin="round" />
      <path d="M1 71.2468V26.5832L44.21 51.6841V96.9415L1 71.2468Z" stroke={color} stroke-linecap="round"
        stroke-linejoin="round" />
    </svg>
  )
}
